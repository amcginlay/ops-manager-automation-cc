...
credhub set -n /pipeline/google/domain-name -t value -v "x"
credhub set -n /pipeline/google/subdomain-name -t value -v "x"
credhub set -n /pipeline/google/gcp-credentials -t value -v "x"
credhub set -n /pipeline/google/gcp-project-id -t value -v "x"
credhub set -n /pipeline/google/opsman-public-ip -t value -v "x"
